...
def namecheck(text):
    ...
    sensitive_words = ["中共", "腐败", "严肃", "查处","共产党","中国共产党","两会代表","两会","国家资本主义","民主","美国","海外"]
...
# a = namecheck('host/Youtube/两会代表人均财富一亿美金，这是财富和权力的盛宴！｜两会｜富豪｜财富｜权利｜马化腾｜马云｜民营企业家｜曾毓群｜习近平｜国家资本主义｜王局拍案20230307.mp4')
# print(a)